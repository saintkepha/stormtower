...
(function() {
  var StormAgent, StormBolt, StormData, StormRegistry, StormTower, TowerMinion, TowerRegistry, agent, config, notifications, stompConnect, storm,
  ...
  TowerMinion = (function(_super) {
    var async, crypto, http, streamBuffers;
  ...
  StormTower = (function(_super) {
    ...
    function StormTower(config) {
      ...
      this["import"](module);
      this.log("Connecting to ", this.config.notifications.producer);
      stompConnect(this.config.notifications.producer, (function(_this) {
        return function(stompclient, path) {
          if (stompclient instanceof Error) {
            return _this.log("Cannot Connect to Notification server");
          } else {
            _this.log("Connect to Notification server " + _this.cohnfig.notifications.producer);
            _this.notifyClient = stompclient;
            return _this.notifyPath = path;
          }
        };
      })(this));
      ...
      this.clients.on('added', (function(_this) {
        return function(bolt) {
          ...
          return minion.once('ready', function() {
            ...
            _this.notifyClient.send(_this.notifyPath, {}, message);
      ...
      this.clients.on('removed', (function(_this) {
        return function(bolt) {
          ...
          _this.minions.remove(bolt.id);
          message = {
            id: bolt.id,
            event_type: 'minion.removed'
          };
          return _this.notifyClient.send(_this.notifyPath, {}, message);
        };
      })(this));
    }
  ...
  if (require.main === module) {
     ...
     */
    notifications = {
      producer: "amq://guest:guest@192.168.102.62:61613/exchange/stormtower/notifications"
    };
    config = {};
