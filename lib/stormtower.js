...
(function() {
  var StormAgent, StormBolt, StormData, StormRegistry, StormTower, TowerMinion, TowerRegistry, agent, storm,
      ...
      return async.whilst((function(_this) {
        ...
        return function(repeat) {
          ...
          try {
            ...
            err = _error;
            return _this.log("monitor - minion discovery request failed:", err);
          } finally {
