  ...
  this.include = function() {
    ...
    this.get({
      '/stormtower/stormflash/*': function() {
        ...
        resZappajs = this.res;
        httpReqSender(httpOptions, null, reqTimeout.get, cname, (function(_this) {
    ...
    this.post({
      '/stormtower/stormflash/*': function() {
        ...
        resZappajs = this.res;
        httpReqSender(httpOptions, this.body, reqTimeout.post, cname, (function(_this) {
          return function(reply) {
    ...
    this.put({
      '/stormtower/stormflash/*': function() {
        ...
        resZappajs = this.res;
        httpReqSender(httpOptions, this.body, reqTimeout.put, cname, (function(_this) {
          return function(reply) {
    ...
    return this.del({
      '/stormtower/stormflash/*': function() {
        ...
        resZappajs = this.res;
        httpReqSender(httpOptions, null, reqTimeout.del, cname, (function(_this) {
          return function(reply) {
